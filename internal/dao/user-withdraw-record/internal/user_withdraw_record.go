...
var userWithdrawRecordColumns = &Columns{
	ID:           "id",
	UID:          "uid",       //
...
func NewUserWithdrawRecord(db *gorm.DB) *UserWithdrawRecord {
	dao := &UserWithdrawRecord{}
	dao.Columns = userWithdrawRecordColumns
	dao.TableName = "user_withdraw_record"
	dao.Database = db
	dao.Table = db.Model(&modelpkg.UserWithdrawRecord{}).Table(dao.TableName)

	return dao
}

// New create a new instance and return
func (dao *UserWithdrawRecord) New(tx *gorm.DB) *UserWithdrawRecord {
	d := &UserWithdrawRecord{}
	d.Columns = dao.Columns
	d.TableName = dao.TableName
	d.Database = tx
	d.Table = tx.Model(&modelpkg.UserWithdrawRecord{}).Table(d.TableName)

	return d
}

// Insert executes an insert command to insert multiple documents into the collection.
func (dao *UserWithdrawRecord) Insert(ctx context.Context, models ...*modelpkg.UserWithdrawRecord) (int64, error) {
	if len(models) == 0 {
...
func (dao *UserWithdrawRecord) Delete(ctx context.Context, filterFunc ...FilterFunc) (int64, error) {
	...
	rst := db.Delete(&modelpkg.UserWithdrawRecord{})

	return rst.RowsAffected, rst.Error
}

// Update executes an update command to update documents in the collection.
func (dao *UserWithdrawRecord) Update(ctx context.Context, filterFunc FilterFunc, updateFunc UpdateFunc) (int64, error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *UserWithdrawRecord) Count(ctx context.Context, filterFunc ...FilterFunc) (count int64, err error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *UserWithdrawRecord) Sum(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (sums []float64, err error) {
...
func (dao *UserWithdrawRecord) Avg(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (avgs []float64, err error) {
	columns := columnFunc(dao.Columns)
	if len(columns) == 0 {
		return
	}
...
func (dao *UserWithdrawRecord) First(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.UserWithdrawRecord, error) {
	var (
		model = &modelpkg.UserWithdrawRecord{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *UserWithdrawRecord) Last(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.UserWithdrawRecord, error) {
	var (
		model = &modelpkg.UserWithdrawRecord{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *UserWithdrawRecord) FindOne(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.UserWithdrawRecord, error) {
	var (
		model = &modelpkg.UserWithdrawRecord{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *UserWithdrawRecord) FindMany(ctx context.Context, filterFunc FilterFunc, columnFunc ColumnFunc, orderFunc OrderFunc, limitAndOffset ...int) ([]*modelpkg.UserWithdrawRecord, error) {
	var (
		models = make([]*modelpkg.UserWithdrawRecord, 0)
		db     = dao.Table.WithContext(ctx)
	)
