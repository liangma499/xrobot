...
var optionWithdrawCurrencyColumns = &Columns{
	ID:           "id",
...
func NewOptionWithdrawCurrency(db *gorm.DB) *OptionWithdrawCurrency {
	dao := &OptionWithdrawCurrency{}
	dao.Columns = optionWithdrawCurrencyColumns
	dao.TableName = "option_withdraw_currency"
	dao.Database = db
	dao.Table = db.Model(&modelpkg.OptionWithdrawCurrency{}).Table(dao.TableName)

	return dao
}

// New create a new instance and return
func (dao *OptionWithdrawCurrency) New(tx *gorm.DB) *OptionWithdrawCurrency {
	d := &OptionWithdrawCurrency{}
	d.Columns = dao.Columns
	d.TableName = dao.TableName
	d.Database = tx
	d.Table = tx.Model(&modelpkg.OptionWithdrawCurrency{}).Table(d.TableName)

	return d
}

// Insert executes an insert command to insert multiple documents into the collection.
func (dao *OptionWithdrawCurrency) Insert(ctx context.Context, models ...*modelpkg.OptionWithdrawCurrency) (int64, error) {
	if len(models) == 0 {
...
func (dao *OptionWithdrawCurrency) Delete(ctx context.Context, filterFunc ...FilterFunc) (int64, error) {
	...
	rst := db.Delete(&modelpkg.OptionWithdrawCurrency{})

	return rst.RowsAffected, rst.Error
}

// Update executes an update command to update documents in the collection.
func (dao *OptionWithdrawCurrency) Update(ctx context.Context, filterFunc FilterFunc, updateFunc UpdateFunc) (int64, error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *OptionWithdrawCurrency) Count(ctx context.Context, filterFunc ...FilterFunc) (count int64, err error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *OptionWithdrawCurrency) Sum(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (sums []float64, err error) {
...
func (dao *OptionWithdrawCurrency) Avg(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (avgs []float64, err error) {
	columns := columnFunc(dao.Columns)
	if len(columns) == 0 {
		return
	}
...
func (dao *OptionWithdrawCurrency) First(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.OptionWithdrawCurrency, error) {
	var (
		model = &modelpkg.OptionWithdrawCurrency{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *OptionWithdrawCurrency) Last(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.OptionWithdrawCurrency, error) {
	var (
		model = &modelpkg.OptionWithdrawCurrency{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *OptionWithdrawCurrency) FindOne(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.OptionWithdrawCurrency, error) {
	var (
		model = &modelpkg.OptionWithdrawCurrency{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *OptionWithdrawCurrency) FindMany(ctx context.Context, filterFunc FilterFunc, columnFunc ColumnFunc, orderFunc OrderFunc, limitAndOffset ...int) ([]*modelpkg.OptionWithdrawCurrency, error) {
	var (
		models = make([]*modelpkg.OptionWithdrawCurrency, 0)
		db     = dao.Table.WithContext(ctx)
	)
