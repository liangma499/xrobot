...
var paymentAmountUserRecordColumns = &Columns{
	ID:          "uid", // 主键
	OrderID:     "order_id",
	UserID:      "user_id",      // 账号
...
func NewPaymentAmountUserRecord(db *gorm.DB) *PaymentAmountUserRecord {
	dao := &PaymentAmountUserRecord{}
	dao.Columns = paymentAmountUserRecordColumns
	dao.TableName = "payment_amount_user_record"
	dao.Database = db
	dao.Table = db.Model(&modelpkg.PaymentAmountUserRecord{}).Table(dao.TableName)

	return dao
}

// New create a new instance and return
func (dao *PaymentAmountUserRecord) New(tx *gorm.DB) *PaymentAmountUserRecord {
	d := &PaymentAmountUserRecord{}
	d.Columns = dao.Columns
	d.TableName = dao.TableName
	d.Database = tx
	d.Table = tx.Model(&modelpkg.PaymentAmountUserRecord{}).Table(d.TableName)

	return d
}

// Insert executes an insert command to insert multiple documents into the collection.
func (dao *PaymentAmountUserRecord) Insert(ctx context.Context, models ...*modelpkg.PaymentAmountUserRecord) (int64, error) {
	if len(models) == 0 {
...
func (dao *PaymentAmountUserRecord) Delete(ctx context.Context, filterFunc ...FilterFunc) (int64, error) {
	...
	rst := db.Delete(&modelpkg.PaymentAmountUserRecord{})

	return rst.RowsAffected, rst.Error
}

// Update executes an update command to update documents in the collection.
func (dao *PaymentAmountUserRecord) Update(ctx context.Context, filterFunc FilterFunc, updateFunc UpdateFunc) (int64, error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *PaymentAmountUserRecord) Count(ctx context.Context, filterFunc ...FilterFunc) (count int64, err error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *PaymentAmountUserRecord) Sum(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (sums []float64, err error) {
...
func (dao *PaymentAmountUserRecord) Avg(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (avgs []float64, err error) {
	columns := columnFunc(dao.Columns)
	if len(columns) == 0 {
		return
	}
...
func (dao *PaymentAmountUserRecord) First(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.PaymentAmountUserRecord, error) {
	var (
		model = &modelpkg.PaymentAmountUserRecord{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *PaymentAmountUserRecord) Last(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.PaymentAmountUserRecord, error) {
	var (
		model = &modelpkg.PaymentAmountUserRecord{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *PaymentAmountUserRecord) FindOne(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.PaymentAmountUserRecord, error) {
	var (
		model = &modelpkg.PaymentAmountUserRecord{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *PaymentAmountUserRecord) FindMany(ctx context.Context, filterFunc FilterFunc, columnFunc ColumnFunc, orderFunc OrderFunc, limitAndOffset ...int) ([]*modelpkg.PaymentAmountUserRecord, error) {
	var (
		models = make([]*modelpkg.PaymentAmountUserRecord, 0)
		db     = dao.Table.WithContext(ctx)
	)
