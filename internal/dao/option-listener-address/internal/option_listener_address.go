...
var optionListenerAddressColumns = &Columns{
	NetWork:     "net_work",
	Address:     "address",
...
func NewOptionListenerAddress(db *gorm.DB) *OptionListenerAddress {
	dao := &OptionListenerAddress{}
	dao.Columns = optionListenerAddressColumns
	dao.TableName = "option_listener_address"
	dao.Database = db
	dao.Table = db.Model(&modelpkg.OptionListenerAddress{}).Table(dao.TableName)

	return dao
}

// New create a new instance and return
func (dao *OptionListenerAddress) New(tx *gorm.DB) *OptionListenerAddress {
	d := &OptionListenerAddress{}
	d.Columns = dao.Columns
	d.TableName = dao.TableName
	d.Database = tx
	d.Table = tx.Model(&modelpkg.OptionListenerAddress{}).Table(d.TableName)

	return d
}

// Insert executes an insert command to insert multiple documents into the collection.
func (dao *OptionListenerAddress) Insert(ctx context.Context, models ...*modelpkg.OptionListenerAddress) (int64, error) {
	if len(models) == 0 {
...
func (dao *OptionListenerAddress) Delete(ctx context.Context, filterFunc ...FilterFunc) (int64, error) {
	...
	rst := db.Delete(&modelpkg.OptionListenerAddress{})

	return rst.RowsAffected, rst.Error
}

// Update executes an update command to update documents in the collection.
func (dao *OptionListenerAddress) Update(ctx context.Context, filterFunc FilterFunc, updateFunc UpdateFunc) (int64, error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *OptionListenerAddress) Count(ctx context.Context, filterFunc ...FilterFunc) (count int64, err error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *OptionListenerAddress) Sum(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (sums []float64, err error) {
...
func (dao *OptionListenerAddress) Avg(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (avgs []float64, err error) {
	columns := columnFunc(dao.Columns)
	if len(columns) == 0 {
		return
	}
...
func (dao *OptionListenerAddress) First(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.OptionListenerAddress, error) {
	var (
		model = &modelpkg.OptionListenerAddress{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *OptionListenerAddress) Last(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.OptionListenerAddress, error) {
	var (
		model = &modelpkg.OptionListenerAddress{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *OptionListenerAddress) FindOne(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.OptionListenerAddress, error) {
	var (
		model = &modelpkg.OptionListenerAddress{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *OptionListenerAddress) FindMany(ctx context.Context, filterFunc FilterFunc, columnFunc ColumnFunc, orderFunc OrderFunc, limitAndOffset ...int) ([]*modelpkg.OptionListenerAddress, error) {
	var (
		models = make([]*modelpkg.OptionListenerAddress, 0)
		db     = dao.Table.WithContext(ctx)
	)
