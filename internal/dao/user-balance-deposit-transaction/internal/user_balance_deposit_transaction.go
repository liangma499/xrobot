...
type Columns struct {
	ID                     string // 主键
	ThirdUID               string // 三方用户ID
	Symbol                 string // 卡号
	Network                string // 币种
	Amount                 string // amount
	DayZeroTime            string //记录的当天
	DepositTransactionTime string //交易时间
	CreateAt               string
	UpdateAt               string
}

var userBalanceDepositTransactionColumns = &Columns{
	ID:                     "id",                       // 主键
	ThirdUID:               "third_uid",                // 三方用户ID
	Symbol:                 "symbol",                   // 卡号
	Network:                "net_work",                 // 币种
	Amount:                 "amount",                   // amount
	DayZeroTime:            "day_zero_time",            //记录的当天
	DepositTransactionTime: "deposit_transaction_time", //交易时间
	CreateAt:               "created_at",
	UpdateAt:               "updated_at",
}

func NewUserBalanceDepositTransaction(db *gorm.DB) *UserBalanceDepositTransaction {
	dao := &UserBalanceDepositTransaction{}
	dao.Columns = userBalanceDepositTransactionColumns
	dao.TableName = "user_balance_deposit_transaction"
	dao.Database = db
	dao.Table = db.Model(&modelpkg.UserBalanceDepositTransaction{}).Table(dao.TableName)

	return dao
}

// New create a new instance and return
func (dao *UserBalanceDepositTransaction) New(tx *gorm.DB) *UserBalanceDepositTransaction {
	d := &UserBalanceDepositTransaction{}
	d.Columns = dao.Columns
	d.TableName = dao.TableName
	d.Database = tx
	d.Table = tx.Model(&modelpkg.UserBalanceDepositTransaction{}).Table(d.TableName)

	return d
}

// Insert executes an insert command to insert multiple documents into the collection.
func (dao *UserBalanceDepositTransaction) Insert(ctx context.Context, models ...*modelpkg.UserBalanceDepositTransaction) (int64, error) {
	if len(models) == 0 {
...
func (dao *UserBalanceDepositTransaction) Delete(ctx context.Context, filterFunc ...FilterFunc) (int64, error) {
	...
	rst := db.Delete(&modelpkg.UserBalanceDepositTransaction{})

	return rst.RowsAffected, rst.Error
}

// Update executes an update command to update documents in the collection.
func (dao *UserBalanceDepositTransaction) Update(ctx context.Context, filterFunc FilterFunc, updateFunc UpdateFunc) (int64, error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *UserBalanceDepositTransaction) Count(ctx context.Context, filterFunc ...FilterFunc) (count int64, err error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *UserBalanceDepositTransaction) Sum(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (sums []float64, err error) {
...
func (dao *UserBalanceDepositTransaction) Avg(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (avgs []float64, err error) {
	columns := columnFunc(dao.Columns)
	if len(columns) == 0 {
		return
	}
...
func (dao *UserBalanceDepositTransaction) First(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.UserBalanceDepositTransaction, error) {
	var (
		model = &modelpkg.UserBalanceDepositTransaction{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *UserBalanceDepositTransaction) Last(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.UserBalanceDepositTransaction, error) {
	var (
		model = &modelpkg.UserBalanceDepositTransaction{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *UserBalanceDepositTransaction) FindOne(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.UserBalanceDepositTransaction, error) {
	var (
		model = &modelpkg.UserBalanceDepositTransaction{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *UserBalanceDepositTransaction) FindMany(ctx context.Context, filterFunc FilterFunc, columnFunc ColumnFunc, orderFunc OrderFunc, limitAndOffset ...int) ([]*modelpkg.UserBalanceDepositTransaction, error) {
	var (
		models = make([]*modelpkg.UserBalanceDepositTransaction, 0)
		db     = dao.Table.WithContext(ctx)
	)
