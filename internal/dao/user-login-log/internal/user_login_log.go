...
var userLoginLogColumns = &Columns{
	ID:      "id",       // 主键
	UID:     "uid",      // 用户ID
	LoginIP: "login_ip", // 登录IP
	LoginAt: "login_at", // 登录时间
}

func NewUserLoginLog(db *gorm.DB) *UserLoginLog {
	dao := &UserLoginLog{}
	dao.Columns = userLoginLogColumns
	dao.TableName = "user_login_log"
	dao.Database = db
	dao.Table = db.Model(&modelpkg.UserLoginLog{}).Table(dao.TableName)

	return dao
}

// New create a new instance and return
func (dao *UserLoginLog) New(tx *gorm.DB) *UserLoginLog {
	d := &UserLoginLog{}
	d.Columns = dao.Columns
	d.TableName = dao.TableName
	d.Database = tx
	d.Table = tx.Model(&modelpkg.UserLoginLog{}).Table(d.TableName)

	return d
}

// Insert executes an insert command to insert multiple documents into the collection.
func (dao *UserLoginLog) Insert(ctx context.Context, models ...*modelpkg.UserLoginLog) (int64, error) {
	if len(models) == 0 {
...
func (dao *UserLoginLog) Delete(ctx context.Context, filterFunc ...FilterFunc) (int64, error) {
	...
	rst := db.Delete(&modelpkg.UserLoginLog{})

	return rst.RowsAffected, rst.Error
}

// Update executes an update command to update documents in the collection.
func (dao *UserLoginLog) Update(ctx context.Context, filterFunc FilterFunc, updateFunc UpdateFunc) (int64, error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *UserLoginLog) Count(ctx context.Context, filterFunc ...FilterFunc) (count int64, err error) {
    db := dao.Table.WithContext(ctx)
...
func (dao *UserLoginLog) Sum(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (sums []float64, err error) {
...
func (dao *UserLoginLog) Avg(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (avgs []float64, err error) {
	columns := columnFunc(dao.Columns)
	if len(columns) == 0 {
		return
	}
...
func (dao *UserLoginLog) First(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.UserLoginLog, error) {
	var (
		model = &modelpkg.UserLoginLog{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *UserLoginLog) Last(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.UserLoginLog, error) {
	var (
		model = &modelpkg.UserLoginLog{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *UserLoginLog) FindOne(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.UserLoginLog, error) {
	var (
		model = &modelpkg.UserLoginLog{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *UserLoginLog) FindMany(ctx context.Context, filterFunc FilterFunc, columnFunc ColumnFunc, orderFunc OrderFunc, limitAndOffset ...int) ([]*modelpkg.UserLoginLog, error) {
	var (
		models = make([]*modelpkg.UserLoginLog, 0)
		db     = dao.Table.WithContext(ctx)
	)
