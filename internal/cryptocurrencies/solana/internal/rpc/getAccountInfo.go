...
func (cl *Client) GetAccountInfo(ctx context.Context, account internal.PublicKey) (out *GetAccountInfoResult, err error) {
...
func (cl *Client) GetAccountDataInto(ctx context.Context, account internal.PublicKey, inVar any) (err error) {
...
// the provided `inVar` parameter with all data associated with the account of provided publicKey.
func (cl *Client) GetAccountDataBorshInto(ctx context.Context, account internal.PublicKey, inVar any) (err error) {
	resp, err := cl.GetAccountInfo(ctx, account)
	if err != nil {
		return err
	}
...
func (cl *Client) getAccountInfoWithOpts(
	...
	if opts != nil {
		...
		if opts.DataSlice != nil {
			...
			if opts.Encoding == internal.EncodingJSONParsed {
