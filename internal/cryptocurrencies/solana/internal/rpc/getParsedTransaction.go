...
func (cl *Client) GetParsedTransaction(
	...
	obj["encoding"] = internal.EncodingJSONParsed
...
func (wrap InstructionInfoEnvelope) GetInstructionInfo() *InstructionInfo {
	return wrap.asInstructionInfo
}
