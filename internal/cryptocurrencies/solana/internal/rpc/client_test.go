...
func TestClient_GetAccountInfo(t *testing.T) {
	...
	pubKey := internal.MustPublicKeyFromBase58(pubkeyString)
	...
	assert.Equal(t,
		&GetAccountInfoResult{
			...
			Value: &Account{
				Lamports: 999999,
				Owner:    internal.MustPublicKeyFromBase58("11111111111111111111111111111111"),
				Data: &DataBytesOrJSON{
					rawDataEncoding: internal.EncodingBase64,
					asDecodedBinary: internal.Data{
						Content:  []byte{0x74, 0x65, 0x73, 0x74},
						Encoding: internal.EncodingBase64,
					},
				},
				Executable: true,
				RentEpoch:  rentEpoch,
...
func TestClient_GetAccountInfoWithOpts(t *testing.T) {
	...
	opts := &GetAccountInfoOpts{
		Encoding:   internal.EncodingJSON,
	...
	assert.Equal(t,
		map[string]any{
			...
			"params": []any{
				pubkeyString,
				map[string]any{
					"encoding":   string(internal.EncodingJSON),
...
func TestClient_GetConfirmedSignaturesForAddress2(t *testing.T) {
	...
	account := internal.MustPublicKeyFromBase58("H7ATJQGhwG8Uf8sUntUognFpsKixPy2buFnXkvyNbGUb")
	limit := uint64(1)
	...
	expected := []*TransactionSignature{
		{Slot: 1, Signature: internal.MustSignatureFromBase58("mgw5vw4tnbou1wVStKckVcVncbpRwfZPcMNbVBoigbSPXBMa3857CNzhwoCkRzM5K7nG32wcbpVJDHttQeBRaHB")},
	}
...
func TestClient_GetConfirmedTransaction(t *testing.T) {
	...
	out, err := client.GetConfirmedTransaction(
		context.Background(),
		internal.MustSignatureFromBase58("53hoZ98EsCMA6L63GWM65M3Bd3WqA4LxD8bcJkbKoKWhbJFqX9M1WZ4fSjt8bYyZn21NwNnV2A25zirBni9Qk6LR"),
	)
	require.NoError(t, err)
	...
	signature, err := internal.SignatureFromBase58("53hoZ98EsCMA6L63GWM65M3Bd3WqA4LxD8bcJkbKoKWhbJFqX9M1WZ4fSjt8bYyZn21NwNnV2A25zirBni9Qk6LR")
	require.NoError(t, err)
	...
	assert.Equal(t, &internal.Transaction{
		Message: internal.Message{
			Header:          internal.MessageHeader{NumRequiredSignatures: 1, NumReadonlySignedAccounts: 0, NumReadonlyUnsignedAccounts: 3},
			RecentBlockhash: internal.MustHashFromBase58("uoEAQCWCKjV9ecsBvngctJ7upNBZX7hpN4SfdR6TaUz"),
			AccountKeys:     []internal.PublicKey{internal.MustPublicKeyFromBase58("GKu2xfGZopa8C9K11wduQWgP4W4H7EEcaNdsUb7mxhyr")},
			Instructions: []internal.CompiledInstruction{
				{Accounts: []uint16{1, 2, 3, 0}, Data: internal.Base58([]byte{0x74, 0x65, 0x73, 0x74}), ProgramIDIndex: 4},
			},
		},
		Signatures: []internal.Signature{signature},
...
// into an `any` type variable, and returns it.
...
func TestClient_GetBlock(t *testing.T) {
	...
	assert.Equal(t,
		map[string]any{
			...
			"params": []any{
				float64(block),
				map[string]any{
					"encoding": string(internal.EncodingBase64),
				},
			},
		},
		reqBody,
	...
	tx1 := &internal.Transaction{
		Message: internal.Message{
			AccountKeys: []internal.PublicKey{
				internal.MustPublicKeyFromBase58("EVd8FFVB54svYdZdG6hH4F4hTbqre5mpQ7XyF5rKUmes"),
				internal.MustPublicKeyFromBase58("72miaovmbPqccdbAA861r2uxwB5yL1sMjrgbCnc4JfVT"),
				internal.MustPublicKeyFromBase58("SysvarS1otHashes111111111111111111111111111"),
				internal.MustPublicKeyFromBase58("SysvarC1ock11111111111111111111111111111111"),
				internal.MustPublicKeyFromBase58("Vote111111111111111111111111111111111111111"),
			},
			...
			Instructions: []internal.CompiledInstruction{
				{
					...
					Data:           internal.Base58([]byte{0x74, 0x65, 0x73, 0x74}),
					ProgramIDIndex: 4,
				},
			},
			RecentBlockhash: internal.MustHashFromBase58("CnyzpJmBydX1X2FyXXzsPFc5WPT9UFdLVkEhnvW33at"),
		},
		Signatures: []internal.Signature{
			internal.MustSignatureFromBase58("D8emaP3CaepSGigD3TCrev7j67yPLMi82qfzTb9iZYPxHcCmm6sQBKTU4bzAee4445zbnbWduVAZ87WfbWbXoAU"),
		},
	}
	tx1Data, err := DataBytesOrJSONFromBase64(tx1.MustToBase64())
	require.NoError(t, err)

	tx2 := &internal.Transaction{
		Message: internal.Message{
			AccountKeys: []internal.PublicKey{
				internal.MustPublicKeyFromBase58("5rxRt2GVpSUFJTqQ5E4urqJCDbcBPakb46t6URyxQ5Za"),
				internal.MustPublicKeyFromBase58("HdzdTTjrmRLYVRy3umzZX4NcUmGTHu6hvYLQN2jGJo53"),
				internal.MustPublicKeyFromBase58("SysvarS1otHashes111111111111111111111111111"),
				internal.MustPublicKeyFromBase58("SysvarC1ock11111111111111111111111111111111"),
				internal.MustPublicKeyFromBase58("Vote111111111111111111111111111111111111111"),
			},
			...
			RecentBlockhash: internal.MustHashFromBase58("BL8oo42yoSTKUYpbXR3kdxeV5X1P8JUUZBZaeBL8K6G"),
		},
		Signatures: []internal.Signature{
			internal.MustSignatureFromBase58("xvrkWXwj5h9SsJvboPMtn4jbR6XNmnHYp4MAikKFwdtkpwMxceFZ46QRzeyGUqm5P1kmCagdUubr3aPdxo7vzyq"),
		},
	}
	tx2Data, err := DataBytesOrJSONFromBase64(tx2.MustToBase64())
	require.NoError(t, err)

	blockTime := internal.UnixTimeSeconds(1625227950)
	assert.Equal(t,
		&GetBlockResult{
			BlockHeight:       pointer.ToUint64(69213636),
			BlockTime:         &blockTime,
			Blockhash:         internal.MustHashFromBase58("5M77sHdwzH6rckuQwF8HL1w52n7hjrh4GVTFiF6T8QyB"),
			ParentSlot:        83987983,
			PreviousBlockhash: internal.MustHashFromBase58("Aq9jSXe1jRzfiaBcRFLe4wm7j499vWVEeFQrq5nnXfZN"),
			Rewards: []BlockReward{
				{
					Lamports:    1595000,
					PostBalance: 482032983798,
					Pubkey:      internal.MustPublicKeyFromBase58("5rL3AaidKJa4ChSV3ys1SvpDg9L4amKiwYayGR5oL3dq"),
...
func TestClient_GetLargestAccounts(t *testing.T) {
	...
	expected := &GetLargestAccountsResult{
		...
		Value: []LargestAccountsResult{
			{
				Address:  internal.MustPublicKeyFromBase58("4Rf9mGD7FeYknun5JczX5nGLTfQuS1GRjNVfkEMKE92b"),
				Lamports: 398178060209179300,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("KchK7WTjPzq9QL5aCwnV1dLsT8rFjruS1Zfzamxus9G"),
				Lamports: 215100454508495000,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("8oRw7qpj6XgLGXYCDuNoTMCqoJnDd6A8LTpNyqApSfkA"),
				Lamports: 99999674507283220,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("9oKrJ9iiEnCC7bewcRFbcdo4LKL2PhUEqcu8gH2eDbVM"),
				Lamports: 97721650553633650,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("3ANJb42D3pkVtntgT6VtW2cD3icGVyoHi2NGwtXYHQAs"),
				Lamports: 91160815129021260,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("K7DbiDcRngs4KY3KxSUcMFNEzXW7iQgi3zFzerXYYDZ"),
				Lamports: 80000000000000000,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("mvines9iiHiQTysrwkJjGf2gb9Ex9jXJX8ns3qwf2kN"),
				Lamports: 53925298123552904,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("71bhKKL89U3dNHzuZVZ7KarqV6XtHEgjXjvJTsguD11B"),
				Lamports: 20949230980018784,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("57DPUrAncC4BUY7KBqRMCQUt4eQeMaJWpmLQwsL35ojZ"),
				Lamports: 18210921605995270,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("hQBS6cu8RHkXcCzE6N8mQxhgrtbNy4kivoRjTMzF2cA"),
				Lamports: 18191952118880490,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("5vxoRv2P12q4K4cWPCJkvPjg6jYnuCYxzF3juJZJiwba"),
				Lamports: 14225826149332328,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("2tZoLFgcbeW8Howq8QMRnExvuwHFUeEnx9ZhHq2qX77E"),
				Lamports: 10099331225079048,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("5NH47Zk9NAzfbtqNpUtn8CQgNZeZE88aa2NRpfe7DyTD"),
				Lamports: 10000060317056686,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("4xxV5Svt3LPsDv81seuqKB4QXxwhdQiFXzbj9GNYXkEr"),
				Lamports: 10000000000000000,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("GoCxdowvFindZVAXP3QsKRP3rR2LZBNXWwp3FB1yZznF"),
				Lamports: 9796480999955000,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("7arfejY2YxX9QrmzHrhu3rG3HofjMqKtfBzQLf8s3Wop"),
				Lamports: 5465066164230830,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("5TkrtJfHoX85sti8xSVvfggVV9SDvhjYjiXe9PqMJVN9"),
				Lamports: 5384143441736968,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("123vij84ecQEKUvQ7gYMKxKwKF6PbYSzCzzURYA4xULY"),
				Lamports: 4350560741967702,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("7vYe2KRUL2sbqSqbCn4UCvn2taaTJWvo3HBsPjZcEogG"),
				Lamports: 3983999997415000,
			},
			{
				Address:  internal.MustPublicKeyFromBase58("7aeNmoVKnbxUSZGukYz2Gyr3UazXpaxATNszKu8XMW1k"),
...
func TestClient_GetProgramAccounts(t *testing.T) {
	...
	opts := GetProgramAccountsOpts{
		Commitment: CommitmentMax,
		Encoding:   internal.EncodingBase58,
		DataSlice: &DataSlice{
			Offset: &offset,
			Length: &length,
		},
	...
	assert.Equal(t,
		map[string]any{
			...
			"params": []any{
				pubkeyString,
				map[string]any{
					"encoding":   string(internal.EncodingBase58),
					"commitment": string(CommitmentMax),
					"dataSlice": map[string]any{
						"offset": float64(offset),
						"length": float64(length),
	...
	expected := GetProgramAccountsResult{
		{
			Pubkey: internal.MustPublicKeyFromBase58("7xLk17EQQ5KLDLDe44wCmupJKJjTGd8hs3eSVVhCx932"),
			Account: &Account{
				Lamports: 2039280,
				Owner:    internal.MustPublicKeyFromBase58("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA"),
				Data: &DataBytesOrJSON{
					asDecodedBinary: internal.Data{
						Content:  []byte{0x74, 0x65, 0x73, 0x74},
						Encoding: internal.EncodingBase64,
...
func TestClient_GetSignaturesForAddress(t *testing.T) {
	...
	before := internal.MustSignatureFromBase58("qN7RF6YSJT5QpVuhPNzjL8zNZ111NKVpJtBD53cxJHinorVW6AYLVE7bYtJnh42RjFfUTSKLrHhDBaG7AtEkymr")
	until := internal.MustSignatureFromBase58("zJTw3PHXJRqpmR2bqnTChcySGET1pZTCQZebCtJbxRp3966MHttJgCgA75jwrjHRPa7mqeuWYceqxqo2jgVAtZa")
...
func TestClient_GetSignatureStatuses(t *testing.T) {
	...
	sig1 := internal.MustSignatureFromBase58("APPAzLobMg62AW7tdot1s7qKjya4Htt7AqjvT4uMUje8FuFNKD6qnoSk3JvBrkBnBnUyknqXJUXpj9BXENSExSQ")
	sig2 := internal.MustSignatureFromBase58("eue8eTRd4puKR2aqsW9AigzyBsF9Em4uVKWKEkMeYUuT9XevvrYwk6Ps5ApCHKEdYDYxPsmE8tb9Gik6jZM1xHT")
...
func TestClient_GetTransaction(t *testing.T) {
	...
	out, err := client.GetTransaction(
		context.Background(),
		internal.MustSignatureFromBase58(tx),
		&opts,
	)
	require.NoError(t, err)
	...
	blockTime := internal.UnixTimeSeconds(blockTimeSeconds)
	expected := &GetTransactionResult{
		Slot:      83311386,
		BlockTime: &blockTime,
		Transaction: &TransactionResultEnvelope{
			asParsedTransaction: &internal.Transaction{
				Signatures: []internal.Signature{
					internal.MustSignatureFromBase58("QPzWhnwHnCwk3nj1zVCcjz1VP7EcAKouPg9Joietje3GnQTVQ5XyWxyPC3zHby8K5ahSn9SbQupauDbVRvv5DuL"),
				},
				Message: internal.Message{
					AccountKeys: []internal.PublicKey{
						internal.MustPublicKeyFromBase58("2ZZkgKcBfp4tW8qCLj2yjxRYh9CuvEVJWb6e2KKS91Mj"),
						internal.MustPublicKeyFromBase58("53R9tmVrTQwJAgaUCWEA7SiVf7eWAbaQarZ159ixt2D9"),
						internal.MustPublicKeyFromBase58("SysvarS1otHashes111111111111111111111111111"),
						internal.MustPublicKeyFromBase58("SysvarC1ock11111111111111111111111111111111"),
						internal.MustPublicKeyFromBase58("Vote111111111111111111111111111111111111111"),
					},
					RecentBlockhash: internal.MustHashFromBase58("6o9C27iJ5rPi7wEpvQu1cFbB1WnRudtsPnbY8GvFWrgR"),
					Instructions: []internal.CompiledInstruction{
						{
							Accounts: []uint16{
								1,
...
func TestClient_GetParsedTransaction(t *testing.T) {
	...
	assert.Equal(t,
		map[string]any{
			...
			"params": []any{
				tx,
				map[string]any{
					"encoding":   string(internal.EncodingJSONParsed),
					"commitment": string(CommitmentMax),
				},
			},
		},
	...
	assert.Equal(t, &InstructionInfo{
		Info: &Info{
			Account:   internal.MustPublicKeyFromBase58("BMnsyyG6S6zkaE3K5X3nbRMKdvBS5dT6HhcMozBVL7Ly"),
			Amount:    "47444666",
			Authority: internal.MustPublicKeyFromBase58("7oPa2PHQdZmjSPqvpZN7MQxnC7Dcf3uL4oLqknGLk2S3"),
			Mint:      internal.MustPublicKeyFromBase58("E942z7FnS7GpswTvF5Vggvo7cMTbvZojjLbFgsrDVff1"),
		},
		InstructionType: "burn",
	}, out.Meta.InnerInstructions[0].Instructions[0].Parsed.asInstructionInfo)
	assert.Equal(t, &InstructionInfo{
		Info: &Info{
			Destination: internal.MustPublicKeyFromBase58("9bFNrXNb2WTx8fMHXCheaZqkLZ3YCCaiqTftHxeintHy"),
			Lamports:    decimal.NewFromFloat(1200),
			Source:      internal.MustPublicKeyFromBase58("G7Hf2J55BAkHtbbXPh94UTGRCQioKPpnb5oKQMBteXo"),
		},
...
func TestClient_GetVoteAccounts(t *testing.T) {
	...
	opts := &GetVoteAccountsOpts{
		VotePubkey: internal.MustPublicKeyFromBase58("vot33MHDqT6nSwubGzqtc6m16ChcUywxV7tNULF19Vu").ToPointer(),
		Commitment: CommitmentMax,
	}
...
func TestClient_GetTokenAccountsByDelegate(t *testing.T) {
	...
	programID := internal.MustPublicKeyFromBase58(programIDString)
...
func TestClient_SendTransaction(t *testing.T) {
	...
	tx, err := internal.TransactionFromDecoder(bin.NewBinDecoder(data))
	require.NoError(t, err)
...
func TestClient_IsBlockhashValid(t *testing.T) {
	...
	blockhash := internal.MustHashFromBase58(blockhashString)
...
func TestClient_GetRecentPrioritizationFees(t *testing.T) {
	...
	accounts := []internal.PublicKey{
		internal.MustPublicKeyFromBase58("41twqNJmPHv8a5AW32if2CcGRcPzaetwErXaNggGWu1q"),
		internal.MustPublicKeyFromBase58("5U3bH5b6XtG99aVWLqwVzYPVpQiFHytBD68Rz2eFPZd7"),
	}
