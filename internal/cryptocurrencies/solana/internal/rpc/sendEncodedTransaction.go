...
// The only difference between this function and SignTransaction is that the latter takes a *internal.Transaction value, as the former takes a raw base64 string
