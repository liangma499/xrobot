...
func (inst *Split) SetStakeAccount(stakeAccount internal.PublicKey) *Split {
	inst.AccountMetaSlice[0] = internal.Meta(stakeAccount).WRITE()
	return inst
}
func (inst *Split) SetNewStakeAccount(voteAcc internal.PublicKey) *Split {
	inst.AccountMetaSlice[1] = internal.Meta(voteAcc).WRITE()
	return inst
}

func (inst *Split) SetStakeAuthority(stakeAuthority internal.PublicKey) *Split {
	inst.AccountMetaSlice[2] = internal.Meta(stakeAuthority).SIGNER()
	return inst
}

func (inst *Split) GetStakeAccount() *internal.AccountMeta    { return inst.AccountMetaSlice[0] }
func (inst *Split) GetNewStakeAccount() *internal.AccountMeta { return inst.AccountMetaSlice[1] }
func (inst *Split) GetStakeAuthority() *internal.AccountMeta  { return inst.AccountMetaSlice[2] }
...
func NewSplitInstruction(
	...
	newStakeAccount internal.PublicKey,
