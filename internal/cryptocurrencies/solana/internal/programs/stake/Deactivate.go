...
func (inst *Deactivate) SetStakeAccount(stakeAccount internal.PublicKey) *Deactivate {
	inst.AccountMetaSlice[0] = internal.Meta(stakeAccount).WRITE()
	return inst
}
func (inst *Deactivate) SetClockSysvar(clockSysvar internal.PublicKey) *Deactivate {
	inst.AccountMetaSlice[1] = internal.Meta(clockSysvar)
	return inst
}
func (inst *Deactivate) SetStakeAuthority(stakeAuthority internal.PublicKey) *Deactivate {
	inst.AccountMetaSlice[2] = internal.Meta(stakeAuthority).SIGNER()
	return inst
}

func (inst *Deactivate) GetStakeAccount() *internal.AccountMeta {
	return inst.AccountMetaSlice[0]
}
func (inst *Deactivate) GetClockSysvar() *internal.AccountMeta {
	return inst.AccountMetaSlice[1]
}
func (inst *Deactivate) GetStakeAuthority() *internal.AccountMeta {
