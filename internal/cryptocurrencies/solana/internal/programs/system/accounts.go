...
type NonceAccount struct {
	Version          uint32
	State            uint32
	AuthorizedPubkey internal.PublicKey
	Nonce            internal.PublicKey
...
func (obj *NonceAccount) UnmarshalWithDecoder(decoder *bin.Decoder) (err error) {
	...
	}
	{
		...
		obj.AuthorizedPubkey = internal.PublicKeyFromBytes(buf)
	}
	{
		buf, err := decoder.ReadNBytes(32)
		if err != nil {
		...
		obj.Nonce = internal.PublicKeyFromBytes(buf)
	}
