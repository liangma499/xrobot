...
var testnetProgramID = internal.MustPublicKeyFromBase58("99999999999999999999999999999999999999999999")
var devnetProgramID = internal.MustPublicKeyFromBase58("99999999999999999999999999999999999999999999")

func ProgramID() internal.PublicKey {

	if custom := os.Getenv("TOKEN_REGISTRY_PROGRAM_ID"); custom != "" {
		return internal.MustPublicKeyFromBase58(custom)
	}
