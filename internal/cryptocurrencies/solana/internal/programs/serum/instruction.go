...
func init() {
	internal.RegisterInstructionDecoder(DEXProgramIDV2, registryDecodeInstruction)
}
...
type InitializeMarketAccounts struct {
	Market        *internal.AccountMeta `text:"linear,notype"`
	SPLCoinToken  *internal.AccountMeta `text:"linear,notype"`
	SPLPriceToken *internal.AccountMeta `text:"linear,notype"`
	CoinMint      *internal.AccountMeta `text:"linear,notype"`
	PriceMint     *internal.AccountMeta `text:"linear,notype"`
}
...
func (i *InstructionInitializeMarket) SetAccounts(accounts []*internal.AccountMeta) error {
	if len(accounts) < 9 {
...
type NewOrderAccounts struct {
	Market             *internal.AccountMeta `text:"linear,notype"`
	OpenOrders         *internal.AccountMeta `text:"linear,notype"`
	RequestQueue       *internal.AccountMeta `text:"linear,notype"`
	Payer              *internal.AccountMeta `text:"linear,notype"`
	Owner              *internal.AccountMeta `text:"linear,notype"` // The owner of the open orders, i.e. the trader
	CoinVault          *internal.AccountMeta `text:"linear,notype"`
	PCVault            *internal.AccountMeta `text:"linear,notype"`
	SPLTokenProgram    *internal.AccountMeta `text:"linear,notype"`
	Rent               *internal.AccountMeta `text:"linear,notype"`
	SRMDiscountAccount *internal.AccountMeta `text:"linear,notype"`
}
...
func (i *InstructionNewOrder) SetAccounts(accounts []*internal.AccountMeta) error {
	if len(accounts) < 9 {
...
type MatchOrderAccounts struct {
	Market            *internal.AccountMeta `text:"linear,notype"`
	RequestQueue      *internal.AccountMeta `text:"linear,notype"`
	EventQueue        *internal.AccountMeta `text:"linear,notype"`
	Bids              *internal.AccountMeta `text:"linear,notype"`
	Asks              *internal.AccountMeta `text:"linear,notype"`
	CoinFeeReceivable *internal.AccountMeta `text:"linear,notype"`
	PCFeeReceivable   *internal.AccountMeta `text:"linear,notype"`
}
...
func (i *InstructionMatchOrder) SetAccounts(accounts []*internal.AccountMeta) error {
	if len(accounts) < 7 {
...
func (i *InstructionConsumeEvents) SetAccounts(accounts []*internal.AccountMeta) error {
	l := len(accounts)
	if l < 4 {
...
type CancelOrderAccounts struct {
	...
	OpenOrders   *internal.AccountMeta `text:"linear,notype"`
	RequestQueue *internal.AccountMeta `text:"linear,notype"`
	Owner        *internal.AccountMeta `text:"linear,notype"`
}
...
type InstructionCancelOrder struct {
	Side          Side
	OrderID       bin.Uint128
	OpenOrders    internal.PublicKey
	OpenOrderSlot uint8

	Accounts *CancelOrderAccounts `bin:"-"`
}

func (i *InstructionCancelOrder) SetAccounts(accounts []*internal.AccountMeta) error {
	if len(accounts) < 4 {
...
type SettleFundsAccounts struct {
	...
	CoinVault        *internal.AccountMeta `text:"linear,notype"`
	PCVault          *internal.AccountMeta `text:"linear,notype"`
	CoinWallet       *internal.AccountMeta `text:"linear,notype"`
	PCWallet         *internal.AccountMeta `text:"linear,notype"`
	Signer           *internal.AccountMeta `text:"linear,notype"`
	SPLTokenProgram  *internal.AccountMeta `text:"linear,notype"`
	ReferrerPCWallet *internal.AccountMeta `text:"linear,notype"`
}
...
func (i *InstructionSettleFunds) SetAccounts(accounts []*internal.AccountMeta) error {
	if len(accounts) < 9 {
...
func (i *InstructionCancelOrderByClientId) SetAccounts(accounts []*internal.AccountMeta) error {
	if len(accounts) < 4 {
...
type DisableMarketAccounts struct {
	Market           *internal.AccountMeta `text:"linear,notype"`
	DisableAuthority *internal.AccountMeta `text:"linear,notype"`
}
...
func (i *InstructionDisableMarketAccounts) SetAccounts(accounts []*internal.AccountMeta) error {
	if len(accounts) < 2 {
...
type SweepFeesAccounts struct {
	Market               *internal.AccountMeta `text:"linear,notype"`
	PCVault              *internal.AccountMeta `text:"linear,notype"`
	FeeSweepingAuthority *internal.AccountMeta `text:"linear,notype"`
	FeeReceivableAccount *internal.AccountMeta `text:"linear,notype"`
	VaultSigner          *internal.AccountMeta `text:"linear,notype"`
	SPLTokenProgram      *internal.AccountMeta `text:"linear,notype"`
}
...
func (i *InstructionSweepFees) SetAccounts(accounts []*internal.AccountMeta) error {
	if len(accounts) < 6 {
...
type NewOrderV2Accounts struct {
	Market          *internal.AccountMeta `text:"linear,notype"` // the market
	OpenOrders      *internal.AccountMeta `text:"linear,notype"` // the OpenOrders account to use
	RequestQueue    *internal.AccountMeta `text:"linear,notype"` // the request queue
	Payer           *internal.AccountMeta `text:"linear,notype"` // the (coin or price currency) account paying for the order
	Owner           *internal.AccountMeta `text:"linear,notype"` // owner of the OpenOrders account
	CoinVault       *internal.AccountMeta `text:"linear,notype"` // coin vault
	PCVault         *internal.AccountMeta `text:"linear,notype"` // pc vault
	SPLTokenProgram *internal.AccountMeta `text:"linear,notype"` // spl token program
	RentSysvar      *internal.AccountMeta `text:"linear,notype"` // the rent sysvar
	FeeDiscount     *internal.AccountMeta `text:"linear,notype"` // (optional) the (M)SRM account used for fee discounts
}
...
func (i *InstructionNewOrderV2) SetAccounts(accounts []*internal.AccountMeta) error {
	if len(accounts) < 9 {
...
type NewOrderV3Accounts struct {
	...
	OpenOrders      *internal.AccountMeta `text:"linear,notype"` // the OpenOrders account to use
	RequestQueue    *internal.AccountMeta `text:"linear,notype"` // the request queue
	EventQueue      *internal.AccountMeta `text:"linear,notype"` // the event queue
	Bidder          *internal.AccountMeta `text:"linear,notype"` // bids
	Asker           *internal.AccountMeta `text:"linear,notype"` // asks
	Payer           *internal.AccountMeta `text:"linear,notype"` // the (coin or price currency) account paying for the order
	Owner           *internal.AccountMeta `text:"linear,notype"` // owner of the OpenOrders account
	CoinVault       *internal.AccountMeta `text:"linear,notype"` // coin vault
	PCVault         *internal.AccountMeta `text:"linear,notype"` // pc vault
...
func (i *InstructionNewOrderV3) SetAccounts(accounts []*internal.AccountMeta) error {
	if len(accounts) < 13 {
...
type CancelOrderV2Accounts struct {
	Market     *internal.AccountMeta `text:"linear,notype"` // 0. `[writable]` market
	Bids       *internal.AccountMeta `text:"linear,notype"` // 1. `[writable]` bids
	Asks       *internal.AccountMeta `text:"linear,notype"` // 2. `[writable]` asks
	OpenOrders *internal.AccountMeta `text:"linear,notype"` // 3. `[writable]` OpenOrders
	Owner      *internal.AccountMeta `text:"linear,notype"` // 4. `[signer]` the OpenOrders owner
	EventQueue *internal.AccountMeta `text:"linear,notype"` // 5. `[writable]` event_q
}
...
func (i *InstructionCancelOrderV2) SetAccounts(accounts []*internal.AccountMeta) error {
	if len(accounts) < 6 {
...
func (i *InstructionCancelOrderByClientIdV2) SetAccounts(accounts []*internal.AccountMeta) error {
	if len(accounts) < 6 {
...
type InstructionSendTakeAccounts struct {
	...
	Asks       *internal.AccountMeta `text:"linear,notype"` // 2. `[writable]` asks
	OpenOrders *internal.AccountMeta `text:"linear,notype"` // 3. `[writable]` OpenOrders
	Owner      *internal.AccountMeta `text:"linear,notype"` // 4. `[]`
}
...
func (i *InstructionSendTake) SetAccounts(accounts []*internal.AccountMeta) error {
	if len(accounts) < 5 {
