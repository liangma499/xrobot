...
func TestDecoder_Market(t *testing.T) {
	...
	assert.Equal(t, internal.MustPublicKeyFromBase58("13iGJcA4w5hcJZDjJbJQor1zUiDLE4jv2rMW9HkD5Eo1"), m.EventQueue)
}
	...
	assert.Equal(t, &Slab{
		BaseVariant: bin.BaseVariant{
			...
			Impl: &SlabLeafNode{
				...
				Owner:         internal.MustPublicKeyFromBase58("77jtrBDbUvwsdNKeq1ERUBcg8kk2hNTzf5E4iRihNgTh"),
				Quantity:      38918,
