...
type MarketMeta struct {
	Address    internal.PublicKey `json:"address"`
...
func (m *MarketMeta) baseSplTokenMultiplier() *big.Int {
	return internal.DecimalsInBigInt(uint32(m.BaseMint.Decimals))
}

func (m *MarketMeta) quoteSplTokenMultiplier() *big.Int {
	return internal.DecimalsInBigInt(uint32(m.QuoteMint.Decimals))
}
