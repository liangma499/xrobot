...
type MarketV2 struct {
	...
	OwnAddress             internal.PublicKey
	VaultSignerNonce       bin.Uint64
	BaseMint               internal.PublicKey
	QuoteMint              internal.PublicKey
	BaseVault              internal.PublicKey
	BaseDepositsTotal      bin.Uint64
	BaseFeesAccrued        bin.Uint64
	QuoteVault             internal.PublicKey
	QuoteDepositsTotal     bin.Uint64
	QuoteFeesAccrued       bin.Uint64
	QuoteDustThreshold     bin.Uint64
	RequestQueue           internal.PublicKey
	EventQueue             internal.PublicKey
	Bids                   internal.PublicKey
	Asks                   internal.PublicKey
