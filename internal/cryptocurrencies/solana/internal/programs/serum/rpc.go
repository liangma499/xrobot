...
func FetchOpenOrders(ctx context.Context, rpcCli *rpc.Client, openOrdersAddr internal.PublicKey) (*OpenOrdersMeta, error) {
...
func FetchMarket(ctx context.Context, rpcCli *rpc.Client, marketAddr internal.PublicKey) (*MarketMeta, error) {
