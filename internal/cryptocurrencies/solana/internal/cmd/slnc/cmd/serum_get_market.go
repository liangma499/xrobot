...
var serumGetMarketCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		marketAddr, err := internal.PublicKeyFromBase58(args[0])
		if err != nil {
...
func getOrderBook(ctx context.Context, market *serum.MarketMeta, cli *rpc.Client, address internal.PublicKey, desc bool) (out []*orderBookEntry, totalSize *big.Float, err error) {
