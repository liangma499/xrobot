...
import (
	...
	"tron_robot/internal/cryptocurrencies/etherscan/internal"
...
const (
	netWorkChannelType            = xtypes.NetWorkChannelType_ETH
	method_ETH          EthMethod = "0x"
	method_transfer     EthMethod = "0xa9059cbb" //: "transfer(address,uint256)",
	method_transferFrom EthMethod = "0x23b872dd" //: "transferFrom(address,address,uint256)",
	method_approve      EthMethod = "0x095ea7b3" //: "approve(address,uint256)",
	method_allowance    EthMethod = "0xdd62ed3e" //: "allowance(address,address)",
	method_balanceOf    EthMethod = "0x70a08231" //: "balanceOf(address)",
	method_totalSupply  EthMethod = "0x18160ddd" //: "totalSupply()",
	method_mint         EthMethod = "0x40c10f19" //: "mint(address,uint256)",
	method_burn         EthMethod = "0x42966c68" //: "burn(uint256)",
)

func (em EthMethod) IsTransfer() bool {
	switch em {
	case method_ETH, method_transfer, method_transferFrom:
		{
			return true
		}
	}
...
func (em EthMethod) Contract(gb *ethInfo, tx *Transaction) (*toTransaction, error) {
	switch em {
	case method_transfer:
		{
...
func NewModuleProxy() (*ethInfo, error) {
	...
	apiCfg := optionCurrencyNetworkCfg.Instance().GetNeedApiByChannelType(netWorkChannelType, xtypes.APIEtherscan)
	if apiCfg == nil {
...
func (gb *ethInfo) HexToInit64(hexStr string) (decimal.Decimal, error) {
	...
	if !b {
		return decimal.Zero, fmt.Errorf("can not to big int")
	}
