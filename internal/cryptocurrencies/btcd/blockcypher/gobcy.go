// Package blockcypher implements a wrapper for the http://www.blockcypher.com API.
...
//
//	bc = blockcypher.API{"your-api-token","btc","main"}
//
...
func getResponse(target *url.URL, decTarget any) (err error) {
...
func postResponse(target *url.URL, encTarget any, decTarget any) (err error) {
...
func putResponse(target *url.URL, encTarget any) (err error) {
	var data bytes.Buffer
	enc := json.NewEncoder(&data)
	if err = enc.Encode(encTarget); err != nil {
		return
